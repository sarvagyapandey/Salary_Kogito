...
public class SpreadsheetSalaryService {
    ...
    public SalaryFact evaluate(Map<String, Object> input) {
        ...
        try {
            ...
            System.out.println("Pass 1 fired: " + fired1 + " rules, Components: " + fact.getComponents().keySet());
            ...
            System.out.println("Pass 2 fired: " + fired2 + " rules, Components: " + fact.getComponents().keySet());

            // Pass 3: catch any remaining rules like Performance Bonus
            int fired3 = session.fireAllRules();
            System.out.println("Pass 3 fired: " + fired3 + " rules, Components: " + fact.getComponents().keySet());
